class CubeEnemy extends Enemy {
  ...
  constructor() {
    super(name = "BasicEnemy", hp = 25, mp = 10, strength = 9, defense = 5, speed = 3, intelligence = 250, level = 3, experiencePoints = 9, items = [ironShield], weapons = [ironSword, ironShield, ironShield, ironShield], scene);
